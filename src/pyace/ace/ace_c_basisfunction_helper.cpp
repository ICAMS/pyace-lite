...
//TODO
//string ACECTildeBasisFunction__repr__(const ACECTildeBasisFunction& func){
////    printf("Inside ACECTildeBasisFunction__repr__\n");
////    printf("func = %ld\n",(void*)func);
////    func.print();
//    return "ACECTildeBasisFunction__repr__";
//}